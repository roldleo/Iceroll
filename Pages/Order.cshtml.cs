...
namespace IceRoll.Pages
{
    ...
    {
        private RolliceContext db;
        public OrderModel(RolliceContext db) => this.db = db;
        ...
        public async Task<IActionResult> OnPostAsync()
            {
                ...
                if(ModelState.IsValid)
                {
                    ...
                    using(var smtp = new SmtpClient())
                    {
                        ...
                        message.Subject = "MyBakery - New Order";
                        message.Body = body;
                        message.IsBodyHtml = true;
                        message.From = new MailAddress("sales@mybakery.com");
